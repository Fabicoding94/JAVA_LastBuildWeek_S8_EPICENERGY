...
public class ClienteService {
    ...
    public void createAndUpdate(ClienteConverter clienteConverter, int clienteId) throws Exception {
        ...
        Cliente cliente = Cliente.builder()
                ...
                .indirizzoOperativo(clienteConverter.getIndirizzoOperativoId() == 0 ? clienteFind.get().getIndirizzoOperativo() : indirizzoOperativoService.getById((long) clienteConverter.getIndirizzoOperativoId()))
                ...
                .telefonoContatto(clienteConverter.getTelefonoContatto() == 0 ? clienteFind.get().getTelefonoContatto() : clienteConverter.getTelefonoContatto())
